/**
 * kilroy.ui_agent_template/manager/create_viewer_agent.js - preflight/postflight functions for kilroy.ui_agent_template/manager/create_viewer_agent
 * @module kilroy.ui_agent_template/manager/create_viewer_agent
 * @file kilroy.ui_agent_template/manager/create_viewer_agent preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.ui_agent_template/manager/create_viewer_agent";
